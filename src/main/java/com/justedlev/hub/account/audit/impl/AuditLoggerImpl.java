...
import com.justedlev.hub.account.audit.AuditLogger;
import com.justedlev.hub.account.audit.AuditableNode;
...
import com.justedlev.hub.account.audit.repository.entity.AuditSnapshot;
...
import static com.justedlev.hub.account.util.CustomCollectors.toCaseInsensitiveSet;
...
public class AuditLoggerImpl implements AuditLogger {
    ...
    private AuditLog toAuditLog(Auditable auditable, Map<String, AuditLog> auditesMap, String entityId) {
        var fields = getFields(auditable.getClass(), withAnnotation(AuditValue.class));
...
//                .toList();
    ...
    private Optional<AuditSnapshot> getNewSnapshot(Auditable auditable, Field field, Map<String, AuditSnapshot> oldValueMap) {
        ...
        var auditColumn = field.getAnnotation(AuditValue.class);
